    ...
    <Link to="../disc">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between h-16 bg-gray-100 rounded-lg shadow-md">
                <span className="font-semibold text-lg px-4">
                  Price: {article.price || "no price"} DZD
                </span>
                <div className="flex items-center justify-center bg-orange-500 text-white h-full w-16">
                  <FaTag size={24} />
                </div>
              ...
              <div className="flex items-center justify-between h-16 bg-gray-100 rounded-lg shadow-md">
                <span className="font-semibold text-lg px-4">
                  {" "}
                  {article.wilaya}, {article.commune}
                </span>
                <div className="flex items-center justify-center bg-orange-500 text-white h-full w-16">
                  <FaMapMarkerAlt size={24} />
                </div>
              ...
              <div className="flex items-center justify-between h-16 bg-gray-100 rounded-lg shadow-md">
                <span className="font-semibold text-lg px-4">
                  Property Type: {article.category}
                </span>
                <div className="flex items-center justify-center bg-orange-500 text-white h-full w-16">
                  <FaHome size={24} />
                </div>
              ...
              <div className="flex items-center justify-between h-16 bg-gray-100 rounded-lg shadow-md">
                <span className="font-semibold text-lg px-4">
                  Nombre de chambres: {article.bedrooms}
                </span>
                <div className="flex items-center justify-center bg-orange-500 text-white h-full w-16">
                  <FaBed size={24} />
                </div>
            ...
            {showContact && (
              <div className="mt-8">
                <ul className="text-gray-700">
                  <li>
                    <strong>Phone:</strong> {article.phone_number}
                  </li>
                  <li>
            ...
            <div className="mt-8">
              ...
              <div className="flex justify-center">
                <button
                  ...
                  className="bg-blue-500 text-white px-4 h-12 rounded-lg text-sm hover:bg-blue-600"
                >
                  ENVOYER UN MESSAGE
                </button>
              </div>
      ...
      <div className="articles">
        ...
        {properties.map((property) => (
          <Article
            receiverId={property.id}
            // Get the user_id (property owner)
