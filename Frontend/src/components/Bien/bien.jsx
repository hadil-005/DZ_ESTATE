              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between h-16 bg-gray-100 rounded-lg shadow-md">
                  <span className="font-semibold text-lg px-4">
                    Price: {article.price || "25,000,000"} DZD
                  </span>
              ...
              {showDescription && (
                <div className="mt-8">
                  <p className="text-gray-700 leading-relaxed">
                    This stunning modern villa is located in the heart of Hydra.
                    With spacious living areas, an open-concept kitchen, and
                    beautifully landscaped gardens, it offers the perfect blend
                    of luxury and comfort. Close to schools, shops, and
                    transportation.
                  </p>
                </div>
              )}
              ...
              {showContact && (
                <div className="mt-8">
                  <ul className="text-gray-700">
                    ...
                    <li>
                      <strong>Email:</strong> flanbenflan@realestate.dz
                    </li>
                  </ul>
                </div>
              )}
